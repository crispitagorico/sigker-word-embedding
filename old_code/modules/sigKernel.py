...
def covariance_train(x_train, n=0):
    ...
    # compute distances
    Parallel(n_jobs=multiprocessing.cpu_count(), max_nbytes=None, verbose=5)(
        delayed(processing_train)(i, x_train, n, dm) for i in range(L))
...
def covariance_test(x_train, x_test, n=0):
    ...
    # compute distances
    Parallel(n_jobs=multiprocessing.cpu_count(), max_nbytes=None, verbose=5)(
        delayed(processing_test)(j, x_train, x_test, n, dm) for j in range(LL))
